    ...
    def get_dataloader(self, shuffle=False) -> DataLoader:
        ...
        if self.dataset.sparse:
            return DataLoader(
                ...
                shuffle=shuffle, num_workers=self.n_workers, collate_fn=collate_sparse_batches
                )
        else:
            return DataLoader(
                self.dataset, batch_size=self.batch_size,
