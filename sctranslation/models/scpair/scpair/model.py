...
class scPair_object():
    def __init__(self,
                 scobj,
                 modalities = {'Gene_Expression': 'zinb','Peaks': 'ber'}, 
                 cov = ['labels'],
                 SEED = 0,
                 hidden_layer = [900, 40],
                 dropout_rate = 0.1,
        ...
        for modality in self.modality_names:
            ...
            for split in ['train', 'val', 'test']:
                if split in split_data:
                    ...
                    if modality in ['Gene_Expression', 'Peaks']:
    ...
    def predict(self):
        ...
        for input_modality in self.modality_names:
            ...
            if self.modalities[output_modality] in ['ber', 'nb', 'zinb'] and ((output_modality == 'Peaks' and self.infer_library_size_atac) or (output_modality == 'Gene_Expression' and self.infer_library_size_rna)):
        ...
        for input_modality in self.modalities.keys():
            ...
            if self.modalities[input_modality] in ['zinb', 'nb', 'ber', 'gau']:
                ...
                encoder = self.input_module(input_dim = train_data_dict[input_modality + '_train_mtx'].shape[1],
                                            ...
                                            infer_library_size = self.infer_library_size_rna if output_modality == 'Gene_Expression' else self.infer_library_size_atac)
