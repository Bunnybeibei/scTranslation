"""CLI entry point for training/testing the JAMIE baseline."""
...
from sctranslation.models.jamie import JAMIERunner  # noqa: E402
from sctranslation.utils.config import Config  # noqa: E402


PREPROCESS = {
    "r": JAMIERunner.preprocessing_pipeline_r,
    "a": JAMIERunner.preprocessing_pipeline_a,
    "p": JAMIERunner.preprocessing_pipeline_p,
}
...
def run_pipeline(
    ...
    """Train or test the JAMIE model on the specified modalities."""
    config = Config(config_path, "JAMIE")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Multi-modal single-cell data translation with JAMIE"
    )
    ...
    parser.add_argument("--model_file", type=str, default="./output/JAMIE/",
                        help="Directory for model checkpoints")
    parser.add_argument("--saved_path", type=str,
                        default="./output/statistics/JAMIE",
                        help="Directory for evaluation outputs")
    parser.add_argument("--data_path", type=str, default="./data/JAMIE",
