"""CLI entry point for training/testing the multiDGD baseline."""
...
from sctranslation.models.multidgd import multiDGDRunner  # noqa: E402
from sctranslation.utils.config import Config  # noqa: E402


PREPROCESS = {
    "r": multiDGDRunner.preprocessing_pipeline_r,
    "a": multiDGDRunner.preprocessing_pipeline_a,
    "p": multiDGDRunner.preprocessing_pipeline_p,
}
...
def run_pipeline(
    ...
    """Train or test the multiDGD model on the specified modalities."""
    config = Config(config_path, "multiDGD")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Multi-modal single-cell data translation with multiDGD"
    )
    ...
    parser.add_argument("--model_file", type=str, default="./output/multiDGD/",
                        help="Directory for model checkpoints")
    parser.add_argument("--saved_path", type=str,
                        default="./output/statistics/multiDGD",
                        help="Directory for evaluation outputs")
    parser.add_argument("--data_path", type=str, default="./data/multiDGD",
