"""CLI entry point for training/testing the scButterfly baseline."""
...
from sctranslation.models.scbutterfly import scButterflyRunner  # noqa: E402
from sctranslation.utils.config import Config  # noqa: E402


PREPROCESS = {
    "r": scButterflyRunner.preprocessing_pipeline_r,
    "a": scButterflyRunner.preprocessing_pipeline_a,
    "p": scButterflyRunner.preprocessing_pipeline_p,
}
...
def run_pipeline(
    ...
    """Train or test the scButterfly model on the specified modalities."""
    config = Config(config_path, "scButterfly")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Multi-modal single-cell data translation with scButterfly"
    )
    ...
    parser.add_argument("--model_file", type=str, default="./output/scButterfly/",
                        help="Directory for model checkpoints")
    parser.add_argument("--saved_path", type=str,
                        default="./output/statistics/scButterfly",
                        help="Directory for evaluation outputs")
    parser.add_argument("--data_path", type=str, default="./data/scButterfly",
